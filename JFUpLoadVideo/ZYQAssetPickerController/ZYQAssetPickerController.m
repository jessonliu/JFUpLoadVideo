...
#define kThumbnailLength  ([UIScreen mainScreen].bounds.size.width - 30) / 2
...
//                [assetView bind:assets[i] selectionFilter:selectionFilter isSeleced:YES];
